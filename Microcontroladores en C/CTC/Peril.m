...
NOTAS=[do(b1),do(b1),fa(b0),fa(b0),...
do(b1),do(b1),fa(b0),fa(b0),...
do(b1),do(b1),fa(b0),fa(b0),...
do(b1),do(b1),do(b1),do(b1),...
res(b1),res(b1),re(b1),re(b1),...
do(b1),do(b1),do(b1),do(b1),...
fa(b0),fa(b0),sol(b0),fa(b0),sol(b0),fa(b0),res(b0),...
do(b1),do(b1),do(b1),do(b1),...
res(b1),res(b1),re(b1),re(b1),...
do(b1),do(b1),do(b1),do(b1),...
fa(b0),fa(b0),sol(b0),fa(b0),sol(b0),fa(b0),res(b0),...
...
do(b1),do(b1),fa(b0),fa(b0),...
do(b1),do(b1),fa(b0),fa(b0),...
do(b2),do(b2),do(b2),do(b2),...
res(b2),res(b2),re(b2),re(b2),...
do(b2),do(b2),do(b2),do(b2),...
fa(b1),fa(b1),sol(b1),fa(b1),sol(b1),fa(b1),res(b1),...
do(b2),do(b2),do(b2),do(b2),...
res(b2),res(b2),re(b2),re(b2),...
do(b2),do(b2),do(b2),do(b2),...
fa(b1),fa(b1),sol(b1),fa(b1),sol(b1),fa(b1),res(b1),...
sol(b1),sol(b1),sol(b1),sol(b1),sol(b1),sol(b1),sol(b1),sol(b1),...
sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),...
do(b2),do(b2),do(b2),do(b2),do(b2),do(b2),do(b2),do(b2),...
sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),...
sol(b1),sol(b1),sol(b1),sol(b1),sol(b1),sol(b1),sol(b1),sol(b1),...
sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),...
do(b2),do(b2),do(b2),do(b2),do(b2),do(b2),do(b2),do(b2),...
sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),...
...
sol(b1),sol(b1),...
do(b2),do(b2),do(b2),do(b2),...
res(b2),res(b2),re(b2),do(b2),re(b2),do(b2),sib(b1),...
do(b2),do(b2),do(b2),do(b2),...
res(b2),res(b2),re(b2),do(b2),re(b2),do(b2),sib(b1),...
do(b2),do(b2),do(b2),do(b2),...
res(b2),res(b2),re(b2),do(b2),re(b2),do(b2),sib(b1),...
do(b2),do(b2),do(b2),do(b2),...
res(b2),res(b2),...
fa(b2),fa(b2),fa(b2),fa(b2),...
sol(b2),sol(b2),sols(b2),sols(b2),sol(b2),sol(b2),...
fa(b2),fa(b2),fa(b2),fa(b2),...
res(b2),res(b2),res(b2),res(b2),fa(b1),...
do(b1),do(b1),sib(b0),sib(b0),...
do(b1),do(b1),fa(b0),fa(b0),...
do(b1),do(b1),fa(b0),fa(b0),...
do(b1),do(b1),fa(b0),fa(b0),...
sol(b1),sol(b1),sol(b1),sol(b1),sol(b1),sol(b1),sol(b1),sol(b1),...
...
sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),sib(b1),...
       s];
DURACION=[n/4,n/2,n/4,n,...
n/4,n/2,n/4,n,...
n/4,n/2,n/4,n,...
n/4,n/2,n/4,n,...
n/4,n/2,n/4,n,...
n/4,n/2,n/4,n,...
n/4,n/2,n/8,n/8,n/8,n/8,n/2,...
n/4,n/2,n/4,n,...
n/4,n/2,n/4,n,...
 n/4,n/2,n/4,n,...
n/4,n/2,n/8,n/8,n/8,n/8,n/2,...
...
n/4,n/4,n/4,n/4,n/4,n/4,n/4,n/4,...
n/4,n/4,n/4,n/4,n/4,n/4,n/4,n/4,...
n/4,n/4,n/4,n/4,n/4,n/4,3*n,n,n];%%89 y 170
%%Agregar silencios
