function varargout = Proyecto_Red_Asociativa(varargin)
% PROYECTO_RED_ASOCIATIVA MATLAB code for Proyecto_Red_Asociativa.fig
%      PROYECTO_RED_ASOCIATIVA, by itself, creates a new PROYECTO_RED_ASOCIATIVA or raises the existing
%      singleton*.
%
%      H = PROYECTO_RED_ASOCIATIVA returns the handle to a new PROYECTO_RED_ASOCIATIVA or the handle to
%      the existing singleton*.
%
%      PROYECTO_RED_ASOCIATIVA('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PROYECTO_RED_ASOCIATIVA.M with the given input arguments.
%
%      PROYECTO_RED_ASOCIATIVA('Property','Value',...) creates a new PROYECTO_RED_ASOCIATIVA or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Proyecto_Red_Asociativa_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Proyecto_Red_Asociativa_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Proyecto_Red_Asociativa

% Last Modified by GUIDE v2.5 04-Dec-2017 18:20:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Proyecto_Red_Asociativa_OpeningFcn, ...
                   'gui_OutputFcn',  @Proyecto_Red_Asociativa_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Proyecto_Red_Asociativa is made visible.
function Proyecto_Red_Asociativa_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Proyecto_Red_Asociativa (see VARARGIN)

% Choose default command line output for Proyecto_Red_Asociativa
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Proyecto_Red_Asociativa wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Proyecto_Red_Asociativa_OutputFcn(hObject, eventdata, handles) 
