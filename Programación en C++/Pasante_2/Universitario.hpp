...
Universitario::Universitario(char escuela[], int calificaciones[],char carrera[],char proyecto[]): Estudiante(escuela,calificaciones){
          strcpy(Carrera,carrera);
          strcpy(Proyecto,proyecto);
         }
void Universitario::Imprimir_Datos_Universitario(){
