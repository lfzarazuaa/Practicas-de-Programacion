 ...
 * Practica_7c.asm
 *
 *  Created: 29/05/2016 11:34:55 p. m.
 *   Author: LuisFernando
 */ 
...
.equ       Const_EEPROM=0x110;;Define el lugar de la RAM donde se guarda el lugar a modificar.
.equ       Cont_L=0x111;;Define el lugar de la RAM donde se guarda el contador de Letra.
.equ       Cont_LCD=0x112;;Define el lugar de la RAM donde se guarda el contador de la posición del LCD.
.equ       LED_Inicio=3;Define el pin del LED de Inicio.
.equ       LED_Paro=2;Define el pin del LED de Paro.
.equ       Boton_Mas=6;
.equ       Boton_Menos=7;
...
Comparacion:
			...
			lds R17,EEPROM_Dato;Carga el dato a R17.
			sub R16,R17;
			brlo Comp2;Si R16 es menor que R17 deja de comparar.
			;Centenas
...
Copiar_2a:  sts EEPROM_Dirl,R17;
            ...
            call ES_EEPROM;
			ldi R16,0x10;
			sts Const_EEPROM,R16;
			call Ing_Datos;
            jmp Fin_Comp;
			;Comparar datos con el segundo jugador.
			;---------------------------------------------------------------------
			;Millares
Comparar_2: ldi R17,0x27;Obtener Dato de Millares.
		    sts EEPROM_Dirl,R17;
		    call LEER_EEPROM;
	        lds R17,EEPROM_Dato;Carga el dato a R17.
			lds R16,ContadorMa;
			...
			lds R17,EEPROM_Dato;Carga el dato a R17.
			sub R16,R17;
			brlo Comp3;Si R16 es menor que R17 deja de comparar.
			;Centenas
			ldi R17,0x28;Obtener Dato de Centenas.
		    sts EEPROM_Dirl,R17;
		    call LEER_EEPROM;
	        lds R17,EEPROM_Dato;Carga el dato a R17.
			lds R16,ContadorCa;
			...
			brlo Comp3;Si R16 es menor que R17 deja de comparar.
			;Decenas
			ldi R17,0x29;Obtener Dato de Decenas.
		    sts EEPROM_Dirl,R17;
		    call LEER_EEPROM;
	        lds R17,EEPROM_Dato;Carga el dato a R17.
			lds R16,ContadorDa;
			...
			brlo Comp3;Si R16 es menor que R17 deja de comparar.
			;Unidades
			ldi R17,0x2A;Obtener Dato de Centenas.
		    sts EEPROM_Dirl,R17;
		    call LEER_EEPROM;
	        lds R17,EEPROM_Dato;Carga el dato a R17.
			lds R16,ContadorUa;
...
Comparar_3: ldi R17,0x47;Obtener Dato de Millares.
			...
			lds R17,EEPROM_Dato;Carga el dato a R17.
			sub R16,R17;
			brlo CompF;Si R16 es menor que R17 deja de comparar.
			;Centenas
...
Ing_Datos:
            andi R24,0xF7;
            ldi R16,0xC0;
            sts Cont_LCD,R16;Carga con la dirección inicial del LCD.
			ldi R16,65;
            sts Cont_L,R16;Carga con 65 corresponiente a la letra A.
			call Colocar_Letra;Coloca la letra en la posición correspondiente.
			call Parpadeo_ON;
Punto:	    sbic pind,Boton_mas;
			call Bmas;
			sbic pind,Boton_menos;
			call Bmenos;
			sbrc R24,3;
			jmp Ingresar;
            jmp Punto;
Bmas:
			...
			breq Pon_l_a1;
			inc R16;
Letra1:     sts Cont_L,R16;
         	call Colocar_Letra;Coloca la letra en la posición correspondiente del LCD.
			ret;
Pon_esp1:
            ldi R16,95;
            jmp Letra1;
...
Ingresar:
            ...
            sts Cont_LCD,R16;
			;Escribir EEPROM.
			lds R16,Const_EEPROM;
		    sts EEPROM_Dirl,R16;
			lds R16,Cont_L;
		    sts EEPROM_Dato,R16;
            call ES_EEPROM;Escribir EEPROM e incrementar su contador.
			;
			lds R16,Const_EEPROM;
		    inc R16;
			sts Const_EEPROM,R16;
			...
			call Colocar_Letra;
			jmp Punto;
Termina_2:	lds R16,Const_EEPROM;
		    sts EEPROM_Dirl,R16;
			lds R16,Cont_L;
		    sts EEPROM_Dato,R16;
            call ES_EEPROM;Escribir EEPROM e incrementar su contador.
            call Parpadeo_OFF;
            ret;Termina de ingresar los datos.
