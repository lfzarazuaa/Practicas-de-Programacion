...
Angulo=180;
for Angulo=0:5:360
% Matriz_Rotacion=[1,0;0,1/cosd(Angulo+1e-5)];%%Matriz giro x.
% Matriz_Rotacion=[1/cosd(Angulo+1e-5),0;0,1];%%Matriz giro y.
 Matriz_Rotacion=[cosd(Angulo),-sind(Angulo);sind(Angulo),cosd(Angulo)];%%Matriz giro y.
