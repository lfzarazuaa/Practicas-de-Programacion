...
% Last Modified by GUIDE v2.5 28-Jan-2015 09:17:57
...
global Lista Grafico Slider
Lista=handles.Lista_2;
Slider=handles.slider1;
Grafico=handles.axes1;
...
% --- Executes on selection change in Lista_2.
function Lista_2_Callback(hObject, eventdata, handles)
% hObject    handle to Lista_2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns Lista_2 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from Lista_2


% --- Executes during object creation, after setting all properties.
function Lista_2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Lista_2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
